...
# Final weight combinations with track ratings
weight_combinations = [
    # Even higher album weights
    {'name': 'album_extreme', 'track': 0.0, 'album': 0.7, 'artist': 0.2, 'genre': 0.1},
    {'name': 'album_super', 'track': 0.0, 'album': 0.8, 'artist': 0.15, 'genre': 0.05},
    # Track + Album combinations
    {'name': 'track_album_heavy', 'track': 0.4, 'album': 0.4, 'artist': 0.15, 'genre': 0.05},
    {'name': 'track_album_balanced', 'track': 0.3, 'album': 0.5, 'artist': 0.15, 'genre': 0.05},
    # Best so far with track weight
    {'name': 'track_album_heaviest', 'track': 0.2, 'album': 0.6, 'artist': 0.15, 'genre': 0.05},
    # Track + Artist combinations
    {'name': 'track_artist_heavy', 'track': 0.4, 'album': 0.3, 'artist': 0.25, 'genre': 0.05},
    {'name': 'track_artist_balanced', 'track': 0.3, 'album': 0.4, 'artist': 0.25, 'genre': 0.05},
]
