...
# Fine-tuned weight combinations around album-heavy
weight_combinations = [
    # Base case (best so far)
    {'name': 'album_heavy_base', 'album': 0.5, 'artist': 0.3, 'genre': 0.2},
    # Increase album weight
    {'name': 'album_heavier', 'album': 0.55, 'artist': 0.3, 'genre': 0.15},
    {'name': 'album_heaviest', 'album': 0.6, 'artist': 0.3, 'genre': 0.1},
    # Decrease album weight slightly
    {'name': 'album_medium', 'album': 0.45, 'artist': 0.35, 'genre': 0.2},
    # Adjust artist weight
    {'name': 'album_artist_balanced', 'album': 0.5, 'artist': 0.35, 'genre': 0.15},
    {'name': 'album_artist_heavy', 'album': 0.5, 'artist': 0.4, 'genre': 0.1},
    # Adjust genre weight
    {'name': 'album_genre_balanced', 'album': 0.5, 'artist': 0.25, 'genre': 0.25},
    {'name': 'album_genre_heavy', 'album': 0.5, 'artist': 0.2, 'genre': 0.3},
]
